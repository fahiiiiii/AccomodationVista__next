  ...
  return (
    <div className="flex flex-col md:flex-row justify-around p-4">
      <div className="flex flex-col w-full md:w-1/2">
        ...
        <h1 className="text-xl md:text-2xl font-bold mb-5">Juneau Vacation Home: Stunning View + Beach Access</h1>
...
const AmenitiesSection = () => {
  return (
    <div className="mb-7">
      <h2 className="text-lg md:text-xl font-bold mb-4">Popular amenities</h2>
...
const ExploreSection = () => {
  return (
    <div className="mt-7">
      <h2 className="text-lg md:text-xl font-bold mb-4">Explore the area</h2>
      {/* Map Section */}
  ...
  return (
    <ul className="list-none flex flex-col items-center mt-4">
      {locations.map((location) => (
        <li key={location.name} className="flex items-center justify-between w-full max-w-md  py-2">
