...
const AboutThisProperty: React.FC = () => {
    return (
        <div className="w-4/5 mx-auto  leading-relaxed p-4">
            <h2 className="text-2xl font-extrabold  mb-4">About this Property</h2>
            <section className="property-info mb-8">
                <h3 className="text-xl md:text-2xl mb-2">Juneau Vacation Home: Stunning View + Beach Access</h3>
            ...
            <section className="the-property-section mb-8">
                ...
                <div className="highlights-section mb-4">
                    ...
                    <ul className="list-none grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {[
